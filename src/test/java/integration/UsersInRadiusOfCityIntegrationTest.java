...
public class UsersInRadiusOfCityIntegrationTest extends BaseIntegrationTest {
    ...
    private final GeodesicClient geodesicClient = new GeodesicClient();

    @Test
    public void shouldReturnUsersInCityRadiusResponseForLondon() {
        ...
        UsersResponse result = userService.findUsersInRadiusOfCity(City.LONDON, 50);
        assertThat(result.getClass(), is(UsersResponse.class));
        assertThat(result.getStatusCode(), Is.is(HttpStatus.OK));
    }

    @Test
    public void shouldReturnUsersInCityRadiusResponseForParis() {
        UserResource userResource = new RestUserResource(restTemplate, API_URL, objectMapper);
